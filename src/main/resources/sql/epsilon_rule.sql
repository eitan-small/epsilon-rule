...
-- ----------------------------
INSERT INTO `epsilon_chain` VALUES ('0cc9c75127c44ddabadee0d8a106c985', 'epsilon-rule', '判断是否进行信贷客户实地检查', 'THEN(\n	node(\"33e1b261f7d5409f9a44fcff6b25cdf7\"),\n	node(\"2732c1f9a80d4f24ab56bead1b25651a\")\n).id(\"33e1b261f7d5409f9a44fcff6b25cdf7\");', '2024-03-08 01:21:15', 1);
INSERT INTO `epsilon_chain` VALUES ('3e9838674b4a4fe0bc7cb367d3144052', 'epsilon-rule', '根据客户信息判断检查频率', 'THEN(\n	node(\"94f35fab86554bb1b5fde760437e4538\"),\n	node(\"c9e562455bc84fc2bf777baa5361fc16\"),\n	node(\"c1e6cefa5a4d47b6b1f5173a5ff9acb4\"),\n	node(\"4884f8a27ece4e3ead56e5a0b306279d\"),\n	node(\"76ad329700174191b1f8b77579155e50\")\n).id(\"94f35fab86554bb1b5fde760437e4538\");', '2024-03-08 01:20:39', 1);
...
-- ----------------------------
-- Table structure for epsilon_menu
-- ----------------------------
DROP TABLE IF EXISTS `epsilon_menu`;
CREATE TABLE `epsilon_menu`  (
  ...
  `menu_category` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '菜单种类 1:规则菜单 | 2:模型菜单',
...
-- ----------------------------
-- Records of epsilon_menu
-- ----------------------------
INSERT INTO `epsilon_menu` VALUES (1, 1, '信贷客户实地检查', '2', '1', 1, NULL, NULL, NULL, '2024-03-13 23:36:01', NULL, 0);
INSERT INTO `epsilon_menu` VALUES (2, 1, '信贷客户实地检查频率', '2', '1', 2, NULL, NULL, NULL, '2024-03-13 23:36:04', NULL, 0);
...
-- ----------------------------
INSERT INTO `epsilon_rule` VALUES (1, '0cc9c75127c44ddabadee0d8a106c985', '判断是否进行信贷客户实地检查', 1, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `epsilon_rule` VALUES (2, '3e9838674b4a4fe0bc7cb367d3144052', '根据客户信息判断检查频率', 1, 1, NULL, NULL, '2024-03-08 01:18:23', NULL, 0);
...
-- ----------------------------
INSERT INTO `epsilon_script` VALUES ('2732c1f9a80d4f24ab56bead1b25651a', 'epsilon-rule', '结束节点', 'outputContext.put(\"isMatched\", inputContext.get(\"isMatched\"));1/0；', 'script', 'js', '2024-03-13 21:47:44', 1);
INSERT INTO `epsilon_script` VALUES ('33e1b261f7d5409f9a44fcff6b25cdf7', 'epsilon-rule', '判断是否执行', 'if (inputContext.get(\"custType\") === \"01\") {\n  inputContext.put(\"isMatched\", true);\n}\nif (inputContext.get(\"custType\") !== \"01\") {\n  inputContext.put(\"isMatched\", false);\n}', 'script', 'js', '2024-03-08 01:21:12', 1);
INSERT INTO `epsilon_script` VALUES ('4884f8a27ece4e3ead56e5a0b306279d', 'epsilon-rule', '取所有频率的最小值', 'inputContext.put(\n  \"finalFeq\",\n  Math.min(\n    inputContext.get(\"finalFeq\"),\n    inputContext.get(\"feq1\"),\n    inputContext.get(\"feq2\"),\n    inputContext.get(\"feq3\"),\n    inputContext.get(\"feq4\"),\n    inputContext.get(\"feq5\"),\n    inputContext.get(\"feq6\")\n  )\n);\n', 'script', 'js', '2024-03-08 01:19:18', 1);
INSERT INTO `epsilon_script` VALUES ('76ad329700174191b1f8b77579155e50', 'epsilon-rule', '结束节点', 'outputContext.put(\"feq\", inputContext.get(\"finalFeq\"));1/0；\n', 'script', 'js', '2024-03-13 21:47:37', 1);
INSERT INTO `epsilon_script` VALUES ('8b54a97118c24ebeaa69696467ab20d7', 'epsilon-rule', '开始节点', NULL, 'script', 'js', '2024-03-08 01:03:53', 1);
